...
import mitt from "./libs/function/mitt";
...
const install = (Vue) => {
  ...
  Vue.config.globalProperties.$timeFormat = (timestamp, format) => {
    return timeFormat(timestamp, format);
  };
  Vue.config.globalProperties.$date = (timestamp, format) => {
    return timeFormat(timestamp, format);
  };
  Vue.config.globalProperties.$timeFrom = (timestamp, format) => {
    return timeFrom(timestamp, format);
  };
  Vue.config.globalProperties.$on = myMitt.on;
