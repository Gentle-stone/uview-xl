...
export default {
  ...
  computed: {
    ...
    iconStyle() {
      ...
      if (
        this.elActiveColor &&
        this.parentData.modelValue == this.name &&
        !this.elDisabled
      ) {
    ...
    iconColor() {
      return this.name == this.parentData.modelValue
        ? "#ffffff"
        : "transparent";
    },
    iconClass() {
  ...
  methods: {
    ...
    emitEvent() {
      ...
      if (this.parentData.modelValue != this.name)
