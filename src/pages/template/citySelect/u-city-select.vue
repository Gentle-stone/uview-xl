...
<script>
import { provinceData as provinces } from "@/uview-xl/libs/util/province.js";
import { cityData as citys } from "@/uview-xl/libs/util/city.js";
import { areaData as areas } from "@/uview-xl/libs/util/area.js";
/**
...
export default {
  name: "u-city-select",
  emits: ["update:modelValue", "city-change"],
  props: {
    // 通过双向绑定控制组件的弹出与收起
    modelValue: {
      type: Boolean,
